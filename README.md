...
### 难检反馈
 ...
 | Mod 下载详情页加载动画 UI 在加载后未能隐藏 | 需要开启调试模式的复现日志以显示加载动画 Debug 信息来修复此问题。<br> *关键词：加载动画、加载图标、Mod 下载、列表、UI、隐藏、消失* | #1624
 | 因系统问题无法打开 PCL | 系统原因，PCL 无法解决。<br> *关键词：.Net、支持库、程序出现未知错误、显卡驱动、闪退、系统不完整* | #2849 #2755 #2751 #2729 #2676 #2580 #2485 #2146 等 Issues
 | 无法检测到 Java | 处理中。<br> *关键词：Java、JDK、搜索、检测、检查、失败、不全、选择。* | #1496
 | 上架微软商店 | 不会制作该功能。 | #1278
