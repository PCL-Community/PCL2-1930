...
### 启动器常见问题
 ...
 | 支持启动器多语言选项<br>· I18n support & Support more languages | 正在 Discussions 中投票，已有相关 Pull Request。<br>· It is being Voted in Discussions. A related Pull Request already exists. | 🔹 **#4145** <br> #891 (#2567)
 ...
 | 支持识别、安装 NeoForge | 快照版已更新，等待正式版同步。 | 🔹 **#4045** <br> #2244
