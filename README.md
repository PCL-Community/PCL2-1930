...
### 启动器常见问题
 ...
 | 支持启动器多语言 | 暂缓处理。 | #891 (#2567) |
 | 增加导出整合包功能 | 暂缓处理。 | #98 (#100)
 ...
 | 1.19.3 不支持自定义皮肤 | 暂缓处理，技术原因。 | #1288 (#1596)
 | Minecraft 更新后 PCL 内未找到该最新版本 | 请在 **设置-启动器-下载-版本列表获取** 选择 **尽量使用官方源**。 | #1226
 | 支持下载地图 | 存在语言问题。 | #44 #135
 | 支持下载资源包（材质包&纹理包） | 暂缓处理。 | #44 (#1095)
 | 支持下载第三方服务端及插件 | PCL 是启动器，此功能超出了启动器的范畴。 | #108
 | 支持光影下载 | 暂缓处理。 | #396 (#2768)
 | 支持数据包下载 | 暂缓处理。 | #2991 (#2994)
 | 引进新 Mod / 整合包下载源 | 没有其他可用的国内的 API。 | #1658
 | 修改、添加、移除、更新已安装版本的 optifine、forge 等组件和模组加载器 | 暂缓处理。 | #220 (#227)
 | 允许管理存档、光影文件 | 不会制作该功能。 | #388 #396
 | 支持导出 Mod 列表 | 暂缓处理。 | #2586 (#2590)
 | 添加 Mod 收藏夹 | 暂缓处理。 | #487 (#1646)
 ...
 | Mod 管理允许选择使用多种排序方式 | 暂缓处理。 | #2698 (#2700)
