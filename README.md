...
### Minecraft 常见问题
 ...
 | 游戏中无声音 | 检查是否静音了 Minecraft 或者其他使用 Java 的进程，在未静音的情况下，请尝试 “版本设置 → 高级管理 → 补全文件”，若问题仍未解决，则尝试关闭 Windows 防火墙后再试。 | #4368
...
### 启动器常见问题
 ...
 | 支持导出 Mod 列表 | 正在 Discussions 中投票。 | #2586
 ...
 | 支持独立网络代理设置 | 正在 Discussion 中投票，已有相关 Pull Request。 | **⇵ #8318** <br> #1228 (#1233)
...
> 如若以下自定义主页出现问题，**请通过下表提供的渠道向主页作者提交反馈，而不是向 PCL2 仓库提交 Issue**。
 ...
 | 杂志主页 | · [GitHub](https://github.com/CreeperIsASpy/Magazine-Homepage-PCL/issues/new) | `http://pclhomeplazaoss.lingyunawa.top:26994/d/Homepages/Ext1nguisher/Custom.xaml` | @CreeperIsASpy
