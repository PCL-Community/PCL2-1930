...
### 启动器常见问题
 ...
 | PCL 消失或报毒 | 为 Microsoft Defender 和 360 等杀毒软件误报，请在 Windows 安全中心和杀毒软件中添加排除项或白名单，具体教程见 PCL 内置帮助库。 |  PCL2 内置帮助库 #56 [#666](https://github.com/Hex-Dragon/PCL2/issues/666#issuecomment-1611534587) 
 | 迁移 Wiki 链接 | 快照版已更新，等待正式版同步更新。在此之前你可以参照迁移通知中的 [“我们需要你的帮助！”](https://zh.minecraft.wiki/w/Minecraft_Wiki:%E8%BF%81%E7%A7%BB%E9%80%9A%E7%9F%A5?variant=zh-cn#%E6%88%91%E4%BB%AC%E9%9C%80%E8%A6%81%E4%BD%A0%E7%9A%84%E5%B8%AE%E5%8A%A9%EF%BC%81) 部分的教程进行操作以使用浏览器插件重定向至新 Wiki 链接。 | #2865 [迁移通知](https://zh.minecraft.wiki/w/Minecraft_Wiki:%E8%BF%81%E7%A7%BB%E9%80%9A%E7%9F%A5?variant=zh-cn#%E6%88%91%E4%BB%AC%E9%9C%80%E8%A6%81%E4%BD%A0%E7%9A%84%E5%B8%AE%E5%8A%A9%EF%BC%81)
 ...
 | 使用 “历史上的今天” 主页时出现乱码 | 为第三方主页问题，非 PCL 问题，请联系主页作者。 | -
 ...
 | 修改、添加、移除、更新已安装版本的 optifine、forge 等组件和模组加载器 | 正在 Discussions 中投票。 | #220 (#227)
 ...
 | 无法准确设置游戏分辨率 | PCL 无法准确设置该数值，因为不同系统环境下窗口标题栏和边框的大小不一致。 | #1478 #1077
...
### 难检反馈
 |内容|相关解释|参考|
 |--|--|--|
 | 因第三方软件或作者引起的问题 | PCL 不会处理第三方造成的问题。 | *[Lable: 第三方](https://github.com/Hex-Dragon/PCL2/issues?q=label%3A%E7%AC%AC%E4%B8%89%E6%96%B9+is%3Aclosed)*
 | 因系统问题无法打开 PCL | 系统原因，PCL 无法解决。<br> *关键词：.Net、支持库、程序出现未知错误、显卡驱动、闪退、系统不完整* | #2849 #2755 #2751 #2729 #2676 #2580 #2485 #2146 等 Issues
 | 上架微软商店 | 不会制作该功能。 | #1278
 ...
 | 切换音乐时概率性切换提示与实际播放歌曲不符 | NAudio 的 Bug，技术上无法处理。 | #866 Hyper-Dragon/DgtAngel#68
...
### 我想交反馈！
#### 0. 在开始之前……
为了提高反馈处理效率，我们推荐遵照以下步骤来提交反馈。在沟通过程中，请保持保持平和友善态度，避免与他人产生言语冲突，这是不利于解决问题的。**请注意，重复反馈、优化建议、新功能提案无法获得活跃橙。**
...
#### 4. 后续处理及跟进工作
若您的反馈被初步确认，Collaborator 将会为您的 Issue 添加 `待处理` label，如信息不足，请依照请求尽快完成信息补充，根据内容复现及相关信息获取难易程度，您需要**尽可能在两周内完成信息补充**，否则您的 Issue 将被超时关闭。但不必但心，若 Issue 关闭后您完成了信息补充，我们会再次进行确认，无误后会重新打开该 Issue。
