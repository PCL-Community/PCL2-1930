...
### 启动器常见问题
 ...
 | 安装整合包时允许修改 Forge 版本 | 修改加载器版本可能会导致兼容性问题，不予考虑，请联系整合包作者解决这个问题 | #3568
...
### 难检反馈
 ...
 | 同时安装 OptiFine 和 ModLoader 导致游戏无法正常加载 | 因为 Optifine 过于激进的优化手段，导致 OptiFine 和 ModLoader 之间存在非常严重的兼容性问题，请考虑只安装 OptiFine 或只安装 Forge，亦或是使用其他 Mod 替代 | #3258 #3566 #3573
