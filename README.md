...
### 启动器常见问题
 ...
 | 支持启动器多语言<br>Support non-Chinese languages | 正在 Discussions 中投票。<br>Voting in Discussions. | #891 (#2567) |
 ...
 | 支持更新 Mod | 处理中。 | #102
 | 支持更新整合包 | 因新旧整合包间可能存在兼容性等冲突问题，不会制作。 | #2854
 ...
 | 无法准确设置游戏分辨率 | PCL 无法准确设置该数值，不同系统环境下窗口标题栏和边框的大小不一致。 | #1478 #1077
