...
### 难检反馈
 ...
 | Minecraft 1.7.10-1.12.2 启动后没有声音 | Mojang BugTracker 已受理此问题，详见 [Initialization of OpenAL fails sometimes]https://bugs.mojang.com/browse/MC-9974，在游戏启动后按下 F3+T 来重新初始化 OpenAL | #3779
 <!-- BUILD_FLAG:END Hard -->
