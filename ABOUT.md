...
本仓库不会开放 Issue 页面，如若你对本仓库有任何建议和问题，请在原始页面下方进行评论。若你的条件和时间允许，可以**选择**向本仓库发起 Pull Request。**但这并不是硬性要求，也不是本仓库创建的最初目的，也不是社区用户的义务**，因此也请不要在原始页面评论中要求他人提交 Pull Request！！
...
你可以随意参考本仓库解决你的问题，同时你也可以引用本仓库的部分条目置于你的作品中来为他人提供解决方案的情况下自愿注明来源，但不得在大面积搬运本仓库的任何内容的情况下不注明来源，这是对该表格贡献者和整理者最基本的尊重。
