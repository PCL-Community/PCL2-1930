...
您可以 **引用本仓库的部分内容**[^1] 来 **在为他人提供解决方案** 的情况下 **自愿或不必注明来源**，但不得在 **大面积搬运本仓库内容**[^2] 的情况下 **不注明来源**。
...
[^1]: **针对 “引用本仓库的部分内容” 的解释**：指在日常正常使用中参考本仓库内容解决问题，或将某（些）条目的解决方案分享给他人解决问题，或将某（些）条目的内容以视频、文档等形式进行分享以供解决问题。严格意义上来说，只要您的行为是尊重社区为这份文档付诸的心血的，是十分欢迎进行分发的。
[^2]: **针对 “大面积搬运本仓库内容” 的解释**：包括但不限于，将表格的全文、某部分的全文进行二次发布或搬运而否认、逃避回答、试图掩盖表格作者或试图将成果在名义上占为己有的，抑或是将相当一部分数量的条目进行二次发布或搬运而否认、逃避回答、试图掩盖表格作者或试图将成果在名义上占为己有的行为。通俗讲，只要在大规模二次分发时标注表格维护者（PCL Community），任何形式的二次分发都是欢迎的。
